...
class ImageApp(object):
    ...
    def __init__(self):
        ...
        self.BASEURL = 'http://iiif-dev.localhost/'
        self.PREFIX = 'services/shim'
    ...
    def handle_GET(self, path):
        ...
        url = self.make_url(x,y,w,h,imageW,imageH,sizeW,sizeH,rot,mirror,quality,format)
    ...
    def make_url(self,x,y,w,h,imageW,imageH,sizeW,sizeH,rot,mirror,quality,format):
